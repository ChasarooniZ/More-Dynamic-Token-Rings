export function getBaseJSON(colorBandStartRadius, colorBandEndRadius, ringColor, ringThickness) {
    return {
        "config": {
            "defaultColorBand": {
                "startRadius": colorBandStartRadius,
                "endRadius": colorBandEndRadius
            },
